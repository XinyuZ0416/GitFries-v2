...
export default function Badge({src, alt, title, description, explanation}: BadgeProps) {
  return (
    <>
    <div className='border-2 border-black shadow-[4px_4px_0px_0px_black] transition-transform duration-150 hover:scale-105 rounded-lg bg-yellow-300 p-4 flex flex-col justify-center items-center'>
