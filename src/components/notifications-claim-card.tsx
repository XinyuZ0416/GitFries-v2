...
export default function NotificationsClaimCard() {
  return (
    <>
    <div className='flex flex-col rounded-lg shadow-sm p-4 gap-2 bg-white hover:bg-gray-100'>
      <h3 className='text-lg font-semibold'>@Banana would like to claim your issue "aaaaaa"</h3>
      <p className="font-normal">Please lemme take it</p>
