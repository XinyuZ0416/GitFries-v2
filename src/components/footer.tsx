...
export default function Footer() {
  return (
    <>
    <footer className="bg-yellow-300 fixed bottom-0 w-full">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://gitfries.com/" className="hover:underline">GitFries™</a>. All Rights Reserved.
          </span>
