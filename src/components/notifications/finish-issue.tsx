          ...
          isAccepted === null ? 
            <>
              <div className='flex justify-center'>
                <button className="transition-transform duration-150 hover:scale-125 border-4 border-black shadow-[4px_4px_0px_0px_black] inline-flex justify-center w-36 px-2 py-1.5 text-md font-bold text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 text-bo"
