...
export default function ChatBubbleReceiver({ url, username, time, content }: ChatBubbleProps) {
  return (
    <div className="flex mr-auto items-start gap-2.5">
      <img className="w-8 h-8 rounded-full" src={url} alt={username} />
      <div className="border-2 border-black flex flex-col w-full max-w-[320px] leading-1.5 p-4 bg-yellow-100 rounded-e-xl rounded-es-xl">
