...
interface IssueClaimDecisionCardProps {
  decision: string,
...
export default function IssueClaimDecisionCard({decision, senderUsername, issueId, issueTitle, time}: IssueClaimDecisionCardProps) {
