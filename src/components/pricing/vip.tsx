    ...
    <div className="transition-transform duration-150 hover:scale-105 border-4 border-black shadow-[4px_4px_0px_0px_black] w-full max-w-sm p-4 bg-white rounded-lg sm:p-8">
      ...
      <ul role="list" className="space-y-5 my-7">
        ...
        <li className="flex items-center">
          ...
          <span className="text-base font-normal leading-tight text-red-500 ms-3">Request to claim up to 3 issues before any gets approved (you can withdraw the requests before approval)</span>
        </li>
        <li className="flex items-center">
          <svg className="shrink-0 w-4 h-4 text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
          </svg>
          <span className="text-base font-normal leading-tight text-red-500 ms-3">Post maximum 3 issues/ month for free, then ￡0.99 each</span>
        </li>
        <li className="flex items-center">
          <svg className="shrink-0 w-4 h-4 text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
