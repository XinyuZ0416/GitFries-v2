...
interface IssueFinishDecisionCardProps {
  decision: string,
...
export default function IssueFinishDecisionCard({decision, senderUsername, issueId, issueTitle, time}: IssueFinishDecisionCardProps) {
