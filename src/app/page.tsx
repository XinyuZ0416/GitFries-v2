...
export default function Home() {
  ...
  return (
    ...
    {/* 2nd screen */}
    <div className="flex flex-col mx-4 mb-5 text-center">
    ...
    <img src="2nd.png" className="max-w-full h-auto object-contain" />

    {/* 3rd screen */}
    <div className="flex flex-col mx-4 my-5 text-center">
    ...
    <img src="3rd.png" className="max-w-full h-auto object-contain" />
