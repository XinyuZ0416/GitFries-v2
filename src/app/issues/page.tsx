    ...
    if (num === 1) {
      return(
        <button key={1} onClick={() => setCurrentPage(1)} 
          className={`font-bold px-3 py-1 mx-1 rounded border-2 border-black transition-transform duration-150 shadow-[4px_4px_0px_0px_black] hover:scale-105 hover:bg-yellow-700 hover:text-white ${currentPage === 1 ? 'bg-yellow-300 text-black' : ''}`}>
          {1}
        </button>
      )
    } else {
      if (!uid) {
        return(
          <button key={num} onClick={() => setCurrentPage(num)}
            className={`font-bold px-3 py-1 mx-1 rounded border-2 border-black transition-transform duration-150 shadow-[4px_4px_0px_0px_black] hover:scale-105 hover:bg-yellow-700 hover:text-white`}>
            {num}
          </button>
        )
      } else {
        return(
          <button key={num} onClick={() => setCurrentPage(num)} 
            className={`font-bold px-3 py-1 mx-1 rounded border-2 border-black transition-transform duration-150 shadow-[4px_4px_0px_0px_black] hover:scale-105 hover:bg-yellow-700 hover:text-white ${currentPage === num ? 'bg-yellow-300 text-black' : ''}`}>
            {num}
          </button>
        )
      }
  ...
  return (
    ...
    <div className="flex justify-center items-center my-10">
      ...
      <div className="flex items-center me-4 transition-transform duration-150 hover:scale-105">
        ...
        <label htmlFor="isFinishedByMe" className="px-4 py-2 
          cursor-pointer select-none 
          rounded-full 
          font-bold text-sm
          border-2 border-black border-dashed
      ...
      <div className="flex items-center me-4 transition-transform duration-150 hover:scale-105">
        ...
        <label htmlFor="isAvailable" className="px-4 py-2 
          cursor-pointer select-none 
          rounded-full 
          font-bold text-sm
          border-2 border-black border-dashed
      ...
      <div className="flex items-center me-4 transition-transform duration-150 hover:scale-105">
        ...
        <label htmlFor="isFavorited" className="px-4 py-2 
          cursor-pointer select-none 
          rounded-full 
          font-bold text-sm
          border-2 border-black border-dashed
      ...
      <div className="flex items-center me-4 transition-transform duration-150 hover:scale-105">
        ...
        <label htmlFor="isEasyFix" className="px-4 py-2 
          cursor-pointer select-none 
          rounded-full 
          font-bold text-sm
          border-2 border-black border-dashed
      ...
      <div className="flex items-center me-4 transition-transform duration-150 hover:scale-105">
        ...
        <label htmlFor="isUrgent" className="px-4 py-2 
          cursor-pointer select-none 
          rounded-full 
          font-bold text-sm
          border-2 border-black border-dashed
