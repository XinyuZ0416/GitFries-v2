  ...
  return (
    ...
    <div className='flex justify-center items-center h-screen'>
      <form className="mx-auto w-2/5">
        <div className="mb-5">
          <label htmlFor="issue_url" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Issue URL *</label>
        ...
        <div className="mb-5">
          <label htmlFor="issue_title" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Issue Title *</label>
          <input type="text" id="issue_title" name='issue_title' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>
        <div className="mb-5">
          <label htmlFor="issue_description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
        ...
        <div className="mb-5 flex flex-row">
          <div>
            <label htmlFor="issue_language" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Language *</label>
          ...
          <div>
            <label htmlFor="issue_difficulty" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Language *</label>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="checkbox-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Urgent</label>
          </div>
        </div>
