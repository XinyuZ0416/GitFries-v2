...
export default function AchievementsPage() {
  ...
  return (
    ...
    <div className="grid grid-flow-col grid-rows-3 gap-4">
      <Badge src='/achievements/colorful/fresh-starter.png' alt='fresh starter' title='fresh starter' 
        description='Planted the seed, now watch it grow.' explanation='Claims and finishes their first issue' />
      <Badge src='/achievements/colorful/first-detonation.png' alt='first detonation' title='first detonation' 
        description='Found the bug. Pulled the pin. Walked away in slow motion.' explanation='Posts their first issue' />
      <Badge src='/achievements/colorful/issue-hoarder.png' alt='issue hoarder' title='issue hoarder' 
        description='If I hoarded it, I solved it!' explanation='Favorites 20 issues' />
      <Badge src='/achievements/colorful/bug-destroyer.png' alt='bug destroyer' title='bug destroyer' 
        description='What bugs?' explanation='Finishes 10 issues' />
      <Badge src='/achievements/colorful/comment-goblin.png' alt='comment goblin' title='comment goblin' 
        description='Lives in the comment section. Probably.' explanation='Leaves 50 comments' />
      <Badge src='/achievements/colorful/merge-monarch.png' alt='merge monarch' title='merge monarch' 
        description='All commits bow to your will!' explanation='Receives 10 requests to approve finished issues' />
      <Badge src='/achievements/colorful/issue-fisher.png' alt='issue fisher' title='issue fisher' 
        description='Baited the hook, and the coders came biting.' explanation='Receives 10 requests to approve claimed issues' />
      <Badge src='/achievements/colorful/speedy-gonzales.png' alt='speedy gonzales' title='speedy gonzales' 
        description='No fix too quick.' explanation="Finishes an issue within an hour after it's posted" />
      <Badge src='/achievements/colorful/time-traveller.png' alt='time traveller' title='time traveller' 
